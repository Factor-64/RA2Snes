...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            refreshIconColor = getRandomColor();
            signOutIconColor = getRandomColor();
            ...
            missableIconColor = getRandomColor();
            progressionIconColor = getRandomColor();
            winConditionIconColor = getRandomColor();
            primedIconColor = getRandomColor();
        }
    }
    ...
    Behavior on refreshIconColor { ColorAnimation { duration: ms } }
    Behavior on signOutIconColor { ColorAnimation { duration: ms } }
    ...
    Behavior on missableIconColor { ColorAnimation { duration: ms } }
    Behavior on progressionIconColor { ColorAnimation { duration: ms } }
    Behavior on winConditionIconColor { ColorAnimation { duration: ms } }
    Behavior on primedIconColor { ColorAnimation { duration: ms } }
}
